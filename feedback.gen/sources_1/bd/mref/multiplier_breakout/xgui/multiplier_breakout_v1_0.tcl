...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ADC_BUS_WIDTH" -parent ${Page_0}
  ipgui::add_param $IPINST -name "ADC_REAL_DATA_WIDTH" -parent ${Page_0}
...
proc update_PARAM_VALUE.ADC_BUS_WIDTH { PARAM_VALUE.ADC_BUS_WIDTH } {
	# Procedure called to update ADC_BUS_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADC_BUS_WIDTH { PARAM_VALUE.ADC_BUS_WIDTH } {
	# Procedure called to validate ADC_BUS_WIDTH
	return true
}

proc update_PARAM_VALUE.ADC_REAL_DATA_WIDTH { PARAM_VALUE.ADC_REAL_DATA_WIDTH } {
	# Procedure called to update ADC_REAL_DATA_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ADC_REAL_DATA_WIDTH { PARAM_VALUE.ADC_REAL_DATA_WIDTH } {
	# Procedure called to validate ADC_REAL_DATA_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.ADC_BUS_WIDTH { MODELPARAM_VALUE.ADC_BUS_WIDTH PARAM_VALUE.ADC_BUS_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADC_BUS_WIDTH}] ${MODELPARAM_VALUE.ADC_BUS_WIDTH}
}

proc update_MODELPARAM_VALUE.ADC_REAL_DATA_WIDTH { MODELPARAM_VALUE.ADC_REAL_DATA_WIDTH PARAM_VALUE.ADC_REAL_DATA_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ADC_REAL_DATA_WIDTH}] ${MODELPARAM_VALUE.ADC_REAL_DATA_WIDTH}
}
